...
(define-fun policy ((c Channel) (time Int)) Rule
  (ite (is-mobile (channel_access c time))
    (ite (is-cam (policy_mobile time (mnode (channel_access c time))))
      norule
      norule)
  (ite (is-infra (channel_access c time))
    (ite (is-cai (policy_infra time (inode (channel_access c time))))
      norule
      norule)
  norule
)))
...
(get-value ((policy Ch1 0) (policy Ch2 0) (policy Ch3 0)))
(get-value ((policy Ch1 1) (policy Ch2 1) (policy Ch3 1)))
(get-value ((policy Ch1 2) (policy Ch2 2) (policy Ch3 2)))
(get-value ((policy Ch1 3) (policy Ch2 3) (policy Ch3 3)))
