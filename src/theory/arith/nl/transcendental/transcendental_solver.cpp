                                            ...
                                            const std::set<Node>& termSet)
{
  ...
  for (auto& am : arithModel)
  {
    ...
    {
      Trace("nl-ext") << "...keep model value " << am.second << " for integer " << am.first
                      << std::endl;
      continue;
    }
    ...
    {
      Trace("nl-ext") << "...keep model value " << am.second << " for purification variable "
                      << am.first << std::endl;
      continue;
    }
    ...
    if (it != trReps.end())
    {
      Trace("nl-ext") << "...abstract value for " << am.first << " from "
                      << am.second << " to " << it->second << std::endl;
      am.second = it->second;
    }
    else
    {
