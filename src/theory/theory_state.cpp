...
context::CDList<Assertion>::const_iterator TheoryState::factsBegin(TheoryId tid) const
{
  return d_valuation.factsBegin(tid);
}
context::CDList<Assertion>::const_iterator TheoryState::factsEnd(TheoryId tid) const
{
