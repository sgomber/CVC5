...
/**
 * The (cetnral) equality engine manager. This encapsulates an architecture
 ...
 *
 * It also allocates a "master" equality engine, which is intuitively the
 * equality engine of the theory of quantifiers. If all theories use the
 * central equality engine, then master equality engine is the central
 * equality engine.
 *
