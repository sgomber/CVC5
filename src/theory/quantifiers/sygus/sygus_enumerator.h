...
class SygusEnumerator : public EnumValGenerator
{
 ...
 private:
  ...
  /** Get the next concrete value generated by this class. */
  Node getCurrentInternal(bool isBuiltin);
  /** Term cache
   *
  ...
  class TermCache
  {
   public:
    ...
    /** is constructor class commutative? */
    bool isConstructorClassComm(unsigned i) const;
   ...
   private:
    ...
    {
     public:
      ConstructorClass() : d_weight(0), d_isComm(false) {}
      ~ConstructorClass() {}
      ...
      /** Constructor weight */
      unsigned d_weight;
      /** Do the constructors in this class have commutative sygus ops? */
      bool d_isComm;
    };
  ...
  class TermEnum
  {
   public:
    ...
    virtual Node getCurrentBuiltin() = 0;
  ...
  class TermEnumSlave : public TermEnum
  {
   public:
    ...
    Node getCurrent() override;
    /** get the builtin version of the current term of the enumerator */
    Node getCurrentBuiltin() override;
