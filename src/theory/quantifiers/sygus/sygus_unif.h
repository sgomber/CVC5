...
class SygusUnif
{
 ...
 protected:
  ...
  virtual Node constructBestStringSolvedTerm(Node e, const std::vector<Node>& solved);
  /** Heuristically choose the best solved conditional term  from solved in
   * context x, currently random */
  virtual Node constructBestSolvedConditional(Node ce, const std::vector<Node>& solved);
  /** Heuristically choose the best conditional term  from conds in context x,
   * currently random */
  virtual Node constructBestConditional(Node ce, const std::vector<Node>& conds);
