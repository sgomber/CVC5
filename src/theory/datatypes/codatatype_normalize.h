 ...
 **
 ** \brief A utility for normalizing codatatype constants.
 **/

#include "cvc4_private.h"

#ifndef CVC4__THEORY__DATATYPES__CODATATYPE_NORMALIZE_H
#define CVC4__THEORY__DATATYPES__CODATATYPE_NORMALIZE_H
