...
private:
   ...
   * else.
   */
  void getExplanation(EqualityEdgeId t1Id, EqualityNodeId t2Id, std::vector<TNode>& equalities, std::map< EqualityEdgeId, std::vector< EqualityEdgeId > >& cache, EqProof* eqp) const;
