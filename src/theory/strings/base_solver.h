...
class BaseSolver : protected EnvObj
{
 ...
 public:
   ...
   */
  CardinalityResponse getCardinalityReq(TypeNode tn, size_t& typeCardSize) const;
  /**
   ...
   */
  bool isCardinalityOk(size_t typeCardSize, Node lr, size_t eqcCount, size_t& lenNeed) const;
