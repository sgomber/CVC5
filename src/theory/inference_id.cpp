...
const char* toString(InferenceId i)
{
  switch (i)
  {
    ...
    case InferenceId::QUANTIFIERS_INST_CCFV_CONFLICT:
      return "QUANTIFIERS_INST_CCFV_CONFLICT";
    case InferenceId::QUANTIFIERS_INST_CCFV_PROP:
      return "QUANTIFIERS_INST_CCFV_PROP";
