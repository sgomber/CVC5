...
class SkolemManager
{
 public:
   ...
   */
  bool isSkolemFunction(const Node& k, SkolemFunId& id, Node& cacheVal) const;
  /**
   * Get the skolem function identifier for k, or SkolemFunId::NONE if it does
   * not have one.
   */
  SkolemFunId getSkolemFunId(const Node& k) const;
  /**
