...
template std::vector<Node> NodeTemplateTrie<false>::getLeaves(size_t depth) const;
template std::vector<Node> NodeTemplateTrie<true>::getLeaves(size_t depth) const;
