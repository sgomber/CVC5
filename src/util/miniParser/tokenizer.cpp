 ...
 *   Elizabeth Polgreen, Daniel Kroening (based on CBMC parser)
 *
...
tokenizert::tokent tokenizert::get_decimal_numeral()
{
...
tokenizert::tokent tokenizert::get_bin_numeral()
{
...
tokenizert::tokent tokenizert::get_hex_numeral()
{
...
tokenizert::tokent tokenizert::get_quoted_symbol()
{
  ...
  throw parser::ParserException("EOF within quoted symbol");
}

tokenizert::tokent tokenizert::get_string_literal()
{
  buffer.clear();
  ...
  throw parser::ParserException("EOF within string literal");
}
...
void tokenizert::get_token_from_stream()
{
  char ch;
