...
class Smt2Printer : public cvc5::internal::Printer
{
 public:
  ...
  void toStreamCmdDefineObjective(std::ostream& out,
                                  ObjectiveKind k,
                                  const Node& t) const override;
  void toStreamCmdDefineMultiObjective(
      std::ostream& out,
      ObjectiveKind k,
      const std::vector<omt::Objective>& children) const override;
  void toStreamCmdOptimizeSat(std::ostream& out,
                              const omt::Objective& obj) const override;
